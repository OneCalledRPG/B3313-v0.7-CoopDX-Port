areas = {
    ...
    [LEVEL_CASTLE] = {
        ...
        [2] = {name = "Vanilla Upstairs", course = "OW (Castle)", color = "blue", stars = {1,2}},
        [3] = {name = "Vanilla Basement", course = "OW (Castle)", color = "blue", stars = {0,3,4}}
    },
    [LEVEL_CASTLE_COURTYARD] = {
        [1] = {name = "Uncanny Courtyard", course = "OW (Courtyard)", color = "blue", stars = {3,4}},
    ...
    [LEVEL_BOB] = {
        [1] = {name = "Crimson Hallway", course = "C1", color = "blue", stars = {3,4}},
        [2] = {name = "3rd Floor (Beta)", course = "C1", color = "blue"},
        [3] = {name = "athletic", course = "C1", color = "yellow", stars = {5}},
        ...
        [7] = {name = "Goomba Hills", course = "C1", color = "yellow", stars = {0,1,2,4,6}}
    },
    [LEVEL_WF] = {
        ...
        [5] = {name = "Flooded Hideout", course = "C2", color = "purple", stars = {0}},
        [6] = {name = "Lavish Lava Mountain", course = "C2", color = "yellow", stars = {3,4,5,6}},
        [7] = {name = "Lavish Lava Mountain", course = "C2", color = "yellow", stars = {3,4,5,6}}
    },
    [LEVEL_JRB] = {
        [1] = {name = "River Mountain", course = "C3", color = "yellow", stars = {0,2,3,6}},
        [2] = {name = "Big Bob-omb's Fortress", course = "C3", color = "purple"},
        [3] = {name = "Piranha Plant Garden", course = "C3", color = "yellow", stars = {4,6}},
        [4] = {name = "Minion Base", course = "C3", color = "yellow"},
        [5] = {name = "Piranha's Igloo", course = "C3", color = "yellow", stars = {0,5}}
    },
    [LEVEL_CCM] = {
        [1] = {name = "Jolly Roger Lagoon", course = "C4", color = "yellow", stars = {0,2}},
        [2] = {name = "Orange Hall", course = "C4", color = "blue", stars = {1}},
        [3] = {name = "Test Level", course = "C4", color = "yellow", stars = {6}},
        [4] = {name = "Checkerboard 1", course = "C4", color = "purple", stars = {3,4}},
        [5] = {name = "Holy Yellow Switch Palace", course = "C4", color = "purple"},
        [6] = {name = "Holy Yellow Switch Palace", course = "C4", color = "purple"}
    },
    [LEVEL_BBH] = {
        [1] = {name = "Whomp's Kingdom", course = "C5", color = "yellow", stars = {1,3,6}},
        [2] = {name = "Whomp's Prison", course = "C5", color = "yellow", stars = {0,2}},
        [3] = {name = "Mountain (B-Roll)", course = "C5", color = "green"},
        [4] = {name = "King Whomp's Battle Arena", course = "C5", color = "purple", stars = {5}},
        [5] = {name = "Flower Fields", course = "C5", color = "yellow"},
        [6] = {name = "Vanish Cap under the Moat (Beta)", course = "C5", color = "yellow", stars = {4}}
    },
    [LEVEL_HMC] = {
        [1] = {name = "Hazy Maze Cave", course = "C6", color = "purple"},
        [2] = {name = "Tick Tock Blocks", course = "C6", color = "yellow", stars = {3,6}},
        [3] = {name = "Midnight Meadow", course = "C6", color = "yellow", stars = {1,4}},
        [4] = {name = "Lethal Cavern", course = "C6", color = "yellow"},
        [5] = {name = "Lonely Forest Path", course = "C6", color = "red"}, --Unused
        [6] = {name = "Cave City", course = "C6", color = "yellow", stars = {2,5}},
        [7] = {name = "Click Clock Climb", course = "C6", color = "yellow"}
    },
    [LEVEL_LLL] = {
        [1] = {name = "Blazing Bully Base", course = "C7", color = "yellow", stars = {0,1,2,5,6}},
        [2] = {name = "Peaceful Sewer Maze", course = "C7", color = "purple"},
        [3] = {name = "Blazing Bully Base", course = "C7", color = "yellow", stars = {0,1,2,5,6}},
        [4] = {name = "Infernal Tower", course = "C7", color = "yellow", stars = {4}},
        [5] = {name = "Fire Bubble (B-Roll)", course = "C7", color = "yellow", stars = {3}}
    },
    [LEVEL_SSL] = {
        [1] = {name = "Desert Maze", course = "C8", color = "yellow", stars = {0,1,6}},
        [2] = {name = "Shifted Sand Land", course = "C8", color = "yellow", stars = {3,4,6}},
        [3] = {name = "Scary Sewer Maze", course = "C8", color = "purple"},
        [4] = {name = "Eyerok's Tomb", course = "C8", color = "purple", stars = {2}},
    ...
    [LEVEL_DDD] = {
        ...
        [2] = {name = "Checkerboard 2", course = "C9", color = "purple", stars = {0}},
        [3] = {name = "Deadly Descent", course = "C9", color = "green"},
        [4] = {name = "Delicious Cake", course = "C9", color = "purple"},
        [5] = {name = "Snow Slide (B-Roll)", course = "C9", color = "yellow", stars = {0,1}},
        [6] = {name = "Snowman's Land (Beta)", course = "C9", color = "yellow", stars = {2}},
        [7] = {name = "Frosty Highlands", course = "C9", color = "yellow", stars = {4,5,6}}
    },
    [LEVEL_SL] = {
        [1] = {name = "Floating Hotel", course = "C10", color = "yellow", stars = {1}},
        [2] = {name = "Haunted Castle Grounds", course = "C10", color = "green"},
        [3] = {name = "Wing Cap by the Rainbow Highway", course = "C10", color = "yellow", stars = {0,3,4}},
        [4] = {name = "Tower of the Wing Cap (Beta)", course = "C10", color = "purple"},
        [5] = {name = "Rainbow Ride (Beta)", course = "C10", color = "yellow", stars = {4}},
        [6] = {name = "Vanish Cap within the Plexus", course = "C10", color = "yellow", stars = {2,5,6}}
    },
    [LEVEL_WDW] = {
        [1] = {name = "Snow Slide (Shoshinkai)", course = "C11", color = "yellow", stars = {0}},
        [2] = {name = "Snowman's Darkness", course = "C11", color = "green"},
        [3] = {name = "Frosty Highlands", course = "C11", color = "yellow"}, --Unused
        [4] = {name = "Cool, Cool Mountain (Beta)", course = "C11", color = "yellow", stars = {0}},
        [5] = {name = "Chief Chilly's Ring", course = "C11", color = "purple", stars = {4}},
        [6] = {name = "Cold, Cold Crevasse", course = "C11", color = "yellow", stars = {2,3}},
        [7] = {name = "Chroma Tundra", course = "C11", color = "yellow", stars = {5,6}}
    },
    [LEVEL_TTM] = {
        [1] = {name = "Tall, Tall Mountain", course = "C12", color = "yellow", stars = {0,2,3,4,5,6}},
    ...
    [LEVEL_THI] = {
        ...
        [2] = {name = "Bob-Omb Tower", course = "C13", color = "yellow", stars = {0,2,6}},
        [3] = {name = "Creepy Cove", course = "C13", color = "yellow"}, --Unused
        [4] = {name = "Grassy Highlands", course = "C13", color = "yellow", stars = {4,5,6}},
        [5] = {name = "Minion Base", course = "C13", color = "yellow", stars = {3,6}},
        [6] = {name = "Peach's Cell", course = "C13", color = "green", stars = {1}},
        [7] = {name = "Peach's Cell", course = "C13", color = "green", stars = {1}}
    },
    [LEVEL_TTC] = {
        [1] = {name = "Big Boo's Haunted Forest", course = "C14", color = "yellow", stars = {1,2,3,6}},
        [2] = {name = "Dark Lobby", course = "C14", color = "blue"},
        [3] = {name = "Plexal Lobby", course = "C14", color = "blue"},
        [4] = {name = "Clock Hall", course = "C14", color = "blue"},
        [5] = {name = "Big Boo's Fortress", course = "C14", color = "yellow", stars = {0}},
        [6] = {name = "Plexal Hallway", course = "C14", color = "blue", stars = {5}},
        [7] = {name = "Bowser's Floor / Peach's Floor", course = "C14", color = "blue", stars = {3}}
    },
    [LEVEL_RR] = {
        [1] = {name = "Jolly Roger Bay (Beta)", course = "C15", color = "yellow", stars = {0,3,4,5,6}},
        [2] = {name = "Wiggler's Forest Fortress", course = "C15", color = "purple"},
        [3] = {name = "Checkerboard 3", course = "C15", color = "purple", stars = {1,2}},
        [4] = {name = "Bowser's Maze", course = "C15", color = "blue"},
        [5] = {name = "Balcony", course = "C15", color = "green"}
    },
    [LEVEL_BITDW] = {
        [1] = {name = "Tiny-Huge Island (Beta)", course = "BC1", color = "yellow", stars = {0}},
        [2] = {name = "Uncanny Courtyard", course = "BC1", color = "blue"},
        [3] = {name = "Creepy Cove", course = "BC1", color = "yellow", stars = {1,2}},
        [4] = {name = "Sunken Castle", course = "BC1", color = "yellow", stars = {4}},
        [5] = {name = "Mario's Maze", course = "BC1", color = "purple"},
        [6] = {name = "Mario's Maze", course = "BC1", color = "purple"}
    },
    [LEVEL_BITFS] = {
        [1] = {name = "Aquarium Limbo", course = "BC2", color = "yellow", stars = {0,2}},
    ...
    [LEVEL_BITS] = {
        [1] = {name = "Wet-Dry World (Beta)", course = "BC3", color = "yellow", stars = {4,5}},
        [3] = {name = "Ice-Cold Warzone", course = "BC3", color = "yellow", stars = {3}},
        [4] = {name = "Bob-Omb Battlefield (Beta)", course = "BC3", color = "yellow", stars = {1,2,3}}
    },
    [LEVEL_BOWSER_1] = {
    ...
    [LEVEL_PSS] = {
        [1] = {name = "Dark Downtown", course = "Slide", color = "yellow", stars = {3}},
        [2] = {name = "castle2", course = "Slide", color = "yellow", stars = {4}},
        [3] = {name = "Cubic Greens", course = "Slide", color = "yellow", stars = {0}},
        [4] = {name = "Jolly Rotom Bay 2", course = "Slide", color = "red"}, --Unused
        [5] = {name = "Bob-Omb Village", course = "Slide", color = "yellow", stars = {1,2,5}},
        [6] = {name = "Dead Village", course = "Slide", color = "purple"},
        [7] = {name = "Plexal Upstairs", course = "Slide", color = "blue"}
    },
    [LEVEL_COTMC] = {
        [1] = {name = "Mountain (B-Roll)", course = "MC", color = "yellow", stars = {0,1,2}},
        [2] = {name = "Goomboss Battle", course = "MC", color = "yellow", stars = {4}},
        [3] = {name = "Sinister Clockwork", course = "MC", color = "purple"},
        [4] = {name = "Whomp's Fortress (Beta)", course = "MC", color = "yellow", stars = {3}},
        [5] = {name = "Tall Floating Fortress", course = "MC", color = "yellow", stars = {5}},
        [6] = {name = "Rocky Trek", course = "MC", color = "yellow"}
    },
    [LEVEL_TOTWC] = {
        [1] = {name = "Eel Graveyard", course = "WC", color = "purple", stars = {0}},
        [2] = {name = "Empty Graveyard", course = "WC", color = "red"}, --Unused
        [3] = {name = "Checkerboard 4", course = "WC", color = "purple", stars = {1,2,3,4,5}},
    ...
    [LEVEL_VCUTM] = {
        [1] = {name = "Battle Fort", course = "VC", color = "yellow", stars = {2}},
        ...
        [5] = {name = "Bob-Omb Test Field", course = "VC", color = "yellow", stars = {0}},
        [6] = {name = "Big Bob-omb's Fortress", course = "VC", color = "purple", stars = {1}}
    },
    [LEVEL_WMOTR] = {
        [1] = {name = "Water Land (Shoshinkai)", course = "S1", color = "yellow", stars = {0,1,2}},
        [2] = {name = "castle1", course = "S1", color = "yellow", stars = {3}},
        [3] = {name = "castle1", course = "S1", color = "yellow", stars = {3}},
    ...
    [LEVEL_SA] = {
        [1] = {name = "Dry Town", course = "S2", color = "yellow", stars = {0,1}},
        [2] = {name = "Wiggler's Forest Fortress", course = "S2", color = "purple", stars = {3}},
        [3] = {name = "Pleasant, Pleasant Falls", course = "S2", color = "yellow", stars = {2,4}},
        [4] = {name = "Sky-High Pathway", course = "S2", color = "yellow", stars = {5}},
        [6] = {name = "Ruins in the Blood Lake", course = "S2", color = "green"}
    },
    [LEVEL_ENDING] = {
        [1] = {name = "Flooded Town", course = "S3", color = "yellow", stars = {0,1,2,3}},
        [2] = {name = "Underground Passageway", course = "S3", color = "blue"},
        [6] = {name = "Wet-Dry World (Beta)", course = "S3", color = "yellow"} --Unused?
    },  
}
...
function b3313_area_name_update() --Updates Playerlist
...
local function on_hud_render()
    ...
    if extendedAreaList then
        ...
        if charSelectOn then
            _G.gServerSettings.enablePlayerList = false
        end
    ...
    if not extendedAreaList then
        if not charSelectOn then
            ...
            gServerSettings.enablePlayerList = false
            _G.gServerSettings.enablePlayerList = true
        end
    end
end
